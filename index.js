...
const getHouse = async () => {
  ...
  const searchResult = await fetch('https://rent.591.com.tw/home/search/rsList?is_new_list=1&type=1&kind=1&searchtype=4&mrtline=100&order=posttime&orderType=desc&region=1&mrt=1&rentprice=4&pattern=3&mrtcoods=4320', {
    headers: {
      'X-CSRF-TOKEN': token,
      'Cookie': cookie,
