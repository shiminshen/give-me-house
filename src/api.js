...
const getHouse = async () => {
  ...
  const searchResult = await fetch('https://rent.591.com.tw/home/search/rsList?is_new_list=1&type=1&kind=1&searchtype=4&mrtline=100&patternMore=3,4&region=1&mrt=1&rentpriceMore=4,5&patternMore=3,4&not_cover=1&mrtcoods=4318,4319,4320,4321,4282&order=posttime&orderType=desc', {
    headers: {
      'X-CSRF-TOKEN': token,
      'Cookie': cookie,
